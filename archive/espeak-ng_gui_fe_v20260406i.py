...
Changelog:
  v20260406i - Added PRESET dropdown with named robotic/sci-fi voice
               approximations (WOPR, HAL 9000, Dalek, GLaDOS, etc.).
               Selecting a preset loads its speed/pitch/amplitude/word-gap
               values into the sliders automatically.
